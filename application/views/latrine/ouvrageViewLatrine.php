	<div class="content">
		...
		<div class="data" style="display: inline;width: 50%;float: left">
                ...
                <div style="display: inline;width: 50%;float: left">
                        <fieldset style="display: inline;width: 50%;float: left"><legend>Ouvrage Assainissement : Puisard</legend>
                        <table>
                            <tr>
                                    <td valign="top">Type latrine</td>
                                    <td><?php echo $source->type_latrine; ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                    <td valign="top">Nombre de Cabines</td>
                                    <td><?php echo $source->nombre_de_cabines; ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                    <td valign="top">Nombre de fosses</td>
                                    <td><?php echo $source->nombre_de_fosses; ?></td>
                            </tr>
                            <tr>
