...
class Bailleur extends CI_Controller {
	...
	function index($offset = 0)
	{
		...
		foreach ($bailleurs as $bailleur)
		{
			...
			$this->table->add_row(++$i, $bailleur->denomination, $type_bailleur, 
				anchor('bailleur/view/'.$bailleur->code_bailleur,'details',array('class'=>'view')).' '.
	...
	function financement($offset = 0){
		...
		foreach ($finances as $finance)
		{
			...
			$this->table->add_row(++$i, $finance->nom_bailleur, $type_bailleur, $finance->nom_projet, $finance->montant_financement, $finance->annee_financement, 
				anchor('bailleur/view_finance/'.$finance->code_finance,'details',array('class'=>'view')).' '.
