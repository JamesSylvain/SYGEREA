...
class CI_Template {
   ...
   function _build_content($region, $wrapper = NULL, $attributes = NULL)
   {
    ...
    function layout($sidebar, $view, $data)
   {
		$this->write_view('sidebar', 'template/'.$sidebar, $data);
		$this->write_view('content', $view, $data);
	//	$this->write_view('footer', 'template/footer', $data);
		$this->render();
