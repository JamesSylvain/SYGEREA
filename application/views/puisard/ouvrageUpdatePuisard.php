...
<form method="post" action="<?php echo $action; ?>">
	...
	<table>
        ...
        <div class="data" style="display: inline;width: 50%;float: right">
                <fieldset style="display: inline;width: 50%;float: right"> <legend>Puisard</legend>
                    <table>
			<tr>
			...
			<tr>
				<td valign="top">Type puisard<span style="color:red;">*</span></td>
                                <td>
                                    <input type="text" name="type_puisard" class="inp-form" value="<?php echo set_value('type_puisard',$this->form_data->type_puisard); ?>"/>
                                    <?php echo form_error('type_puisard'); ?>
				</td>
			</tr>
			<tr>
